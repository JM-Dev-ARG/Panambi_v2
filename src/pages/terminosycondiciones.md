# Términos y Condiciones - Panambi

**Última actualización:** Noviembre 2025

## 1. Información General

Estos Términos y Condiciones regulan la relación contractual entre Panambi (en adelante, "el Proveedor") y el Cliente que contrata cualquiera de los servicios ofrecidos. Al contratar nuestros servicios, el Cliente acepta estos términos en su totalidad.

## 2. Condiciones Generales Aplicables a Todos los Servicios

### 2.1 Contratación y Aceptación

La contratación de cualquier servicio implica la aceptación expresa de estos Términos y Condiciones. El Cliente declara ser mayor de edad y contar con capacidad legal para contratar.

### 2.2 Precio y Forma de Pago

Los precios de cada servicio están expresados en la moneda indicada en la propuesta o factura correspondiente. El Cliente deberá abonar el monto total o las cuotas acordadas según las condiciones establecidas para cada servicio específico.

### 2.3 Propiedad Intelectual

Todo material desarrollado por Panambi para el Cliente (diseños, estrategias, código, contenido audiovisual, etc.) es propiedad del Cliente una vez abonado el servicio en su totalidad. El Proveedor se reserva el derecho de utilizar dichos trabajos en su portafolio con fines promocionales, salvo acuerdo de confidencialidad específico.

### 2.4 Confidencialidad

Ambas partes se comprometen a mantener la confidencialidad de la información sensible compartida durante la prestación del servicio. Esto incluye datos comerciales, financieros, estratégicos y cualquier información que el Cliente designe como confidencial.

### 2.5 Responsabilidad y Límites
...
### 2.6 Modificaciones y Cancelaciones

Cualquier modificación al alcance del servicio contratado deberá ser acordada por escrito entre ambas partes y podrá implicar ajustes en el precio y plazos de entrega.

Las políticas de cancelación varían según el servicio contratado y se detallan en cada sección específica.
...
Ninguna de las partes será responsable por incumplimientos derivados de circunstancias de fuerza mayor o caso fortuito que escapen a su control razonable.

### 2.9 Resolución de Conflictos

En caso de controversia, ambas partes se comprometen a intentar resolverla mediante negociación directa. De no alcanzarse un acuerdo, se someterán a la jurisdicción de los tribunales competentes en Argentina.

---

## 3. Condiciones Específicas por Servicio

### 3.1 Asesoría One Shot

**Descripción del servicio:**
Encuentro sincrónico de una hora donde se realiza diagnóstico personalizado, auditoría de presencia online, análisis del modelo de negocio y entrega de plan de acción estratégico.
...
### 3.2 Consultoría Estratégica

**Descripción del servicio:**
Programa integral de consultoría orientado a profesionales y empresas del sector servicios, que incluye análisis del negocio, estrategia de crecimiento, marketing digital y posicionamiento de marca.
...
**Descripción del servicio:**
Diseño y desarrollo de sitios web personalizados, optimizados para SEO, responsive y adaptados a las necesidades específicas del Cliente.
...
Se incluyen hasta 2-3 rondas de revisiones (según presupuesto). Modificaciones adicionales fuera del alcance original se presupuestan por separado.
...
### 3.4 Diseño Audiovisual

**Descripción del servicio:**
Creación de contenido audiovisual y piezas gráficas para redes sociales, sitios web, campañas publicitarias, incluyendo edición de video, audio, animaciones y motion graphics.
...
### 4.1 Modificaciones a los Términos

Panambi se reserva el derecho de modificar estos Términos y Condiciones en cualquier momento. Las modificaciones entrarán en vigor para nuevos contratos. Los contratos en curso se regirán por los términos vigentes al momento de su contratación.

### 4.2 Comunicaciones

Todas las comunicaciones oficiales se realizarán a través de los medios de contacto proporcionados por ambas partes (email, WhatsApp, plataformas de videollamada).

### 4.3 Validez

Si alguna cláusula de estos Términos fuese declarada nula o inaplicable, el resto de las cláusulas mantendrán su plena vigencia.
...
Al contratar cualquier servicio de Panambi, el Cliente declara haber leído, comprendido y aceptado estos Términos y Condiciones en su totalidad.

**Para consultas sobre estos términos:**
Contacto: info@panambi.net
Sitio web: https://panambi.net

---

_Este documento constituye el acuerdo completo entre las partes en relación con los servicios contratados y reemplaza cualquier acuerdo previo, oral o escrito._
